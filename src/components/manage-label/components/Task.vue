...
export default {
    ...
    methods:{
        deletetask(){
            this.$http.delete("https://my-blog-67f7c-default-rtdb.firebaseio.com/labels/"+this.task.id+".json")
            .catch(err => {
                alert('连接错误');
                console.log(err);
            });
        ...
        check(){
            if(this.task.text==''){
                ...
                this.$http.put('https://my-blog-67f7c-default-rtdb.firebaseio.com/labels/'
